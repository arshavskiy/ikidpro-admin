  ...
  <div class="space-y-6">
    ...
    >
      <div class="mb-4">
        ...
        <p class="text-sm text-gray-600">Add Users to join this business</p>
      </div>
      ...
      <div class="mb-4">
        <h5 class="text-md font-medium text-gray-900 mb-3">
          Users to Add ({{ usersToInvite.length }})
        </h5>
        <div
